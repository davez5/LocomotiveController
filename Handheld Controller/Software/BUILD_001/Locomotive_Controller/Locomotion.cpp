...
Locomotion::Locomotion(uint16_t velocity, bool forward):speed(velocity),isForward(forward),ComInterface(LOCOMOTION_TYPE)
{
...
void Locomotion::sendData(NewSoftSerial *_Serial)
{     
